document.addEventListener("DOMContentLoaded", () => {
    ...
    function hideAllSections() {
      ...
      buttons.forEach((button) => {
        button.style.backgroundColor = "#Fff0f5"; // Reset to light blue
        button.style.color = "#000000"; // Reset font color to black
        button.style.boxShadow = "#800080";
      });
    }
  
    function styleButton(button) {
      button.style.backgroundColor = "#Fff0f5"; // Light blue background
    ...
    function createButton(button, label, section) {
      ...
      button.addEventListener("click", () => {
        ...
        button.style.backgroundColor = "#FB48C4"; // White background when active
        button.style.color = "#000000"; // Black font when active
        button.style.justifyContent = 'center';
      });
